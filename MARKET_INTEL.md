...
Ogni volta che Sabrina condivide una JD, Claude:
1. Analizza match per JOBS.md
2. Estrae da questa JD: pain points, linguaggio usato, skills richieste, salary range
3. Aggiorna le sezioni sotto con i nuovi pattern

Ogni volta che Sabrina condivide ricerca (subreddit, gruppi, articoli, conversazioni), Claude estrae gli stessi pattern.

---

## Linguaggio dei Clienti (Coliseum Keywords)

Parole e frasi esatte usate nelle JD e nelle conversazioni per descrivere il problema che Sabrina risolve. Ordinate per frequenza.
...
Pattern di problemi che le aziende stanno cercando di risolvere attraverso queste assunzioni.

| Pain Point | Frequenza | Evidenza |
|-----------|-----------|----------|
| Dipartimenti che non comunicano | Alta | "cross-functional" in 7/10 JD; Prosolbia: "alineación cross-funcional" |
...
Ancora vuota — si popola man mano che Sabrina condivide ricerca o report da conversazioni.
