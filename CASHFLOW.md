...
| Opportunità | Tipo | Rate | Status | Rischio |
|-------------|------|------|--------|---------|
| Stephy/SheAI — Workshop teaching | Delivery | €80-120/h | Proposto | ⚠️ Tornare a delivery tecnica (contro la strategia) |
| Stephy/SheAI — Consulting | Delivery | TBD | — | Possibile contro-proposta: "diagnosis before automation" con audit a pagamento |
| Juno House Workshop (con Samantha) | Workshop | TBD | In definizione | Samantha fa brand specialist — da capire formato e compenso |
